...
#ifdef HAVE_LIBIDN
/*
 * mutt_idn_version:    print idn libray version, be called in version.c
 *
 * */
const char *mutt_idn_version(void)
{
...
#ifdef HAVE_LIBIDN2
/*
 * mutt_idn2_version:    print idn2 libray version, be called in version.c
 *
 * */
const char *mutt_idn2_version(void)
{
	static char vstring[STRING];
	snprintf(vstring, sizeof(vstring),
